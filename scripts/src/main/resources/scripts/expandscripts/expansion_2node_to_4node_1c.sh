...
litp create -p /deployments/d1/clusters/c1 -t vcs-cluster -o cluster_type=vcs low_prio_net=mgmt llt_nets='hb1,hb2' cluster_id="${cluster_id}" default_nic_monitor="mii"
...
# REMOVE EXISTING SG
#Removed as this is a critical service
