...
#
# Usage:
#   expansion_2node_to_4node_1cluster_vxvm_vcs_network_hosts.sh <CLUSTER_SPEC_FILE>
#
...
for (( i=0; i<${#node_expansion_sysname[@]}; i++ )); do
    ...
    #NETWORK HOSTS
    litp create -t vcs-network-host -p /deployments/d1/clusters/c$cluster/network_hosts/nh30 -o ip=172.16.200.133 network_name=traffic2
    litp create -t vcs-network-host -p /deployments/d1/clusters/c$cluster/network_hosts/nh31 -o ip=172.16.201.5 network_name=traffic3
