...
# CREATE THE PARALLEL SERVICE GROUP
litp create -p /software/images/image6 -t vm-image -o name="PL_SG_vm4" source_uri="http://${ms_ip}/images/vm_image_rhel6.qcow2"
...
# CREATE THE PARALLEL SERVICE GROUP
litp create -p /software/images/image7 -t vm-image -o name="PL_SG_vm5" source_uri="http://${ms_ip}/images/vm_image_rhel6.qcow2"
