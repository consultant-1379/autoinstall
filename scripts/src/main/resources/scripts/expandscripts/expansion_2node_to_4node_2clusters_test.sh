...
#
# Usage:
#   expansion_2node_to_4node_2clusters.sh <CLUSTER_SPEC_FILE>
#
...
# REMOVE DEPENDENCIES and Contract Parallel SG
litp update -p /deployments/d1/clusters/c1/services/"$FO_SG_pkg" -o dependency_list=$PL_SG_pkg
litp update -p /deployments/d1/clusters/c1/services/"$PL_SG_pkg" -o dependency_list="" node_list='n1' active=1
