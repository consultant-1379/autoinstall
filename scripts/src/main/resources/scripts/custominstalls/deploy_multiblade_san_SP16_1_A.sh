...
litp create -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/physical_devices/data -t physical-device -o device_name=hd1
...
litp create -p /infrastructure/systems/sys1/disks/disk0 -t disk -o name='hd0' size='15G' bootable=true uuid="${ms_disk_uuid}"
litp create -p /infrastructure/systems/sys1/disks/disk1 -t disk -o name='hd1' size='25G' bootable=false uuid=${ms_disk_uuid_sdb}
