...
litp create -p /deployments/d1/clusters/c1/services/"$SL_SG_pkg"/ha_configs/conf1 -t ha-service-config -o status_interval=100 status_timeout=60 restart_limit=6 startup_retry_limit=3 fault_on_monitor_timeouts=6 tolerance_limit=10 clean_timeout=60
