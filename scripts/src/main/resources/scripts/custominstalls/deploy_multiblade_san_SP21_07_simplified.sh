#!/bin/bash
#
# LITP multi-blade deployment (SAN version)
...
#
# Usage:
#   deploy_multiblade_san_SP21_07_simplified.sh <CLUSTER_SPEC_FILE>
#
...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/dataA        -o type='ext4' mount_point='/nested/nested/dataA'    size=400M
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/data_umount  -o type='ext4'                         size='48M'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs1          -o type='ext4' mount_point='/'         size='35G' snap_size='15'
...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs3          -o type='ext4' mount_point='/home'     size='6G'  snap_size='15'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs4          -o type='ext4' mount_point='/var'      size='35G' snap_size='15'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs5          -o type='ext4' mount_point='/var/log'  size='20G' snap_size='15'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs6          -o type='ext4' mount_point='/var/www'  size='70G' snap_size='15'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs7          -o type='ext4' mount_point='/software' size='70G' snap_size='15'
...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs8          -o type='ext4' mount_point='/var/lib/mysql'  size='25G' snap_size='10'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs9          -o type='ext4' mount_point='/var/lib/libvirt' size='20G' snap_size='10'
