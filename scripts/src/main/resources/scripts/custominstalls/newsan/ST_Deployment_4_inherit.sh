...
# KS FS modelling
litp create -t file-system -p /infrastructure/storage/storage_profiles/sp1/volume_groups/vg1/file_systems/root -o type=ext4 mount_point=/ size=35G snap_size=100 backup_snap_size=100
...
litp create -t file-system -p /infrastructure/storage/storage_profiles/sp1/volume_groups/vg1/file_systems/var -o type=ext4 mount_point=/var size=35G snap_size=100 backup_snap_size=100
litp create -t file-system -p /infrastructure/storage/storage_profiles/sp1/volume_groups/vg1/file_systems/software -o type=ext4 mount_point=/software size=70G snap_size=0 backup_snap_size=0
for (( i=0; i<6; i++ )); do
