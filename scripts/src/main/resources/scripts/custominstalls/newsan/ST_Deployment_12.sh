...
# MS KS FS modelling
litp create -t file-system -p /infrastructure/storage/storage_profiles/sp3/volume_groups/vg1/file_systems/root -o type=ext4 mount_point=/ size=35G snap_size=100 backup_snap_size=100
...
litp create -t file-system -p /infrastructure/storage/storage_profiles/sp3/volume_groups/vg1/file_systems/var -o type=ext4 mount_point=/var size=35G snap_size=100 backup_snap_size=100
litp create -t file-system -p /infrastructure/storage/storage_profiles/sp3/volume_groups/vg1/file_systems/software -o type=ext4 mount_point=/software size=70G snap_size=0 backup_snap_size=0
...
litp create -t vm-image -p /software/images/img_vm1 -o name=vm1_1 source_uri=http://ms1dot90/images/vm_image_rhel7.qcow2
...
litp create -t vm-image -p /software/images/img_vm2 -o name=vm1_2 source_uri=http://ms1dot90/images/vm_image_rhel7.qcow2
...
# SETUP VM ON THE MS
litp create -t vm-image -p /software/images/img_vm3 -o name=vm1_3 source_uri=http://ms1dot90/images/vm_image_rhel7.qcow2
