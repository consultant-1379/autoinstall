...
litp create -t vcs-network-host -p /deployments/d1/clusters/c1/network_hosts/nh1 -o network_name="mgmt"     ip="192.168.101.10"
...
litp create -t vcs-network-host -p /deployments/d1/clusters/c1/network_hosts/nh6 -o network_name="traffic1" ip="192.168.101.11"
litp create -t vcs-network-host -p /deployments/d1/clusters/c1/network_hosts/nh7 -o network_name="traffic1" ip="2001:ABCD:F0::11"
litp create -t vcs-network-host -p /deployments/d1/clusters/c1/network_hosts/nh8 -o network_name="traffic2" ip="192.168.101.12"
