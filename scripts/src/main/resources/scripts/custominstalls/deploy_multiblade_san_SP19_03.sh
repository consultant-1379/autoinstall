...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs1          -o type='ext4' mount_point='/'         size='15G' snap_size='15'
...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs4          -o type='ext4' mount_point='/var'      size='15G' snap_size='15'
...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs7          -o type='ext4' mount_point='/software' size='50G' snap_size='15'
