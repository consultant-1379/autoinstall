...
litp create -p /infrastructure/storage/storage_profiles/profile_1/volume_groups/vg1/file_systems/data1 -t file-system -o type=ext4 mount_point=nested/data1 size=2G snap_size=0
...
#done
# SETUP THE VM_IMAGE
#/usr/bin/md5sum /var/www/html/images/image_with_ocf_v1_8.qcow2 | cut -d ' ' -f 1 | tee /var/www/html/images/image_with_ocf_v1_8.qcow2.md5 2>&1
#retval=( $(echo "$?") )
#if [ $retval -ne 0 ]
#then
#    exit 1
