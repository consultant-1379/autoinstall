...
litp create -p /infrastructure/storage/storage_profiles/profile_2/volume_groups/vg3_vxvm/file_systems/data3_vxvm -t file-system -o type=vxfs mount_point=/data4 size=100M snap_size=100
