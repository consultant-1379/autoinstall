...
SG_pkg[x]="luci";    SG_rel[x]="63.el6";     SG_ver[x]="0.26.0";   SG_VIP_count[x]=4;      SG_active[x]=1; SG_standby[x]=1 status_interval[x]=10	status_timeout[x]=10	restart_limit[x]=0	startup_retry_limit[x]=0	node_list[x]="n1,n2" initial_online_dependency_list[x]="SG_cups"  	   x=$[$x+1]
...
litp create -t package -p /software/items/cups-libs   -o name=cups-libs   version=1.4.2  release=67.el6 repository=OS 
...
litp create -t vm-yum-repo -p /software/services/se_vm1/vm_yum_repos/updates -o name=vm_UPDATES base_url=http://ms1dot90/6.6/updates/x86_64/Packages
litp create -t vm-yum-repo -p /software/services/se_vm1/vm_yum_repos/os -o name=vm_os base_url=http://"${net1vm_ip_ms}"/6.6/os/x86_64
...
litp create -t vm-yum-repo -p /software/services/se_vm2/vm_yum_repos/updates -o name=vm_UPDATES base_url=http://ms1dot90/6.6/updates/x86_64/Packages
litp create -t vm-yum-repo -p /software/services/se_vm2/vm_yum_repos/os -o name=vm_os base_url=http://"${net1vm_ip_ms}"/6.6/os/x86_64
...
litp create -t vm-yum-repo -p /ms/services/se_vm3/vm_yum_repos/updates -o name=vm_UPDATES base_url=http://ms1dot90/6.6/updates/x86_64/Packages
litp create -t vm-yum-repo -p /ms/services/se_vm3/vm_yum_repos/os -o name=vm_os base_url=http://"${net1vm_ip_ms}"/6.6/os/x86_64
