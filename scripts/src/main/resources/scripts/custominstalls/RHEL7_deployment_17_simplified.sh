...
#
# Usage:
#   RHEL7_deploment_17_simplified.sh <CLUSTER_SPEC_FILE>
#
...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs7          -o type='xfs' mount_point='/software' size='150G' snap_size=0
...
litp create -p /infrastructure/systems/sys1/disks/disk0 -t disk -o name=hd0 size=800G bootable=true uuid="${ms_disk_uuid}"
