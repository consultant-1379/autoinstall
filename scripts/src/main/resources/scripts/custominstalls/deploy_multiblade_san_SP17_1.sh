...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/dataA        -o type='ext4' mount_point='/dataA'    size=400M
...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs1          -o type='ext4' mount_point='/'         size='15G' snap_size='10'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs2          -o type='swap' mount_point='swap'      size='2G'  snap_size='10'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs3          -o type='ext4' mount_point='/home'     size='6G'  snap_size='10'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs4          -o type='ext4' mount_point='/var'      size='15G' snap_size='10'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs5          -o type='ext4' mount_point='/var/log'  size='20G' snap_size='10'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs6          -o type='ext4' mount_point='/var/www'  size='70G' snap_size='10'
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs7          -o type='ext4' mount_point='/software' size='50G' snap_size='10'
