...
litp create -t alias -p /ms/configs/alias_config/aliases/fwServer -o alias_names="fwServer","dot30","ciNode" address="${ntp_ip}"
...
#Add Java Pck to MS
litp create -t package -p /software/items/openjdk -o name=EXTRserverjre_CXP9035480
...
litp create -t dhcp-service -p /software/services/dhcp -o service_name="dhcp" ntpservers="${ntp_ip}","atsfsx82-data1.ammeonvpn.com","10.44.86.72","helios.ammeonvpn.com" nameservers=10.44.86.212 domainsearch=ammeonvpn.com,litp.com,libvirt.com
