...
litp create -p /infrastructure/storage/storage_profiles/profile_2/volume_groups/vg1_vxvm/file_systems/data1_vxvm -t file-system -o type=vxfs size=2G snap_size=100
...
litp create -p /infrastructure/storage/storage_profiles/profile_2/volume_groups/vg2_vxvm/file_systems/data2_vxvm -t file-system -o type=vxfs size=2G snap_size=100
...
litp create -p /infrastructure/storage/storage_profiles/profile_2/volume_groups/vg3_vxvm/file_systems/data3_vxvm -t file-system -o type=vxfs size=2G snap_size=100
