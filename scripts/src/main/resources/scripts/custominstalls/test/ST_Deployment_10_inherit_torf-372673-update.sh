...
# TORF-372673 Replace rsyslog with elasticsearch 
litp create -p /software/items/EXTRlitprsyslogelasticsearch_CXP9032173 -t package -o name=EXTRlitprsyslogelasticsearch_CXP9032173 replaces=rsyslog7
litp inherit -p /deployments/d1/clusters/c1/nodes/n1/items/EXTRlitprsyslogelasticsearch_CXP9032173 -s /software/items/EXTRlitprsyslogelasticsearch_CXP9032173
litp inherit -p /deployments/d1/clusters/c1/nodes/n2/items/EXTRlitprsyslogelasticsearch_CXP9032173 -s /software/items/EXTRlitprsyslogelasticsearch_CXP9032173
litp inherit -p /ms/items/EXTRlitprsyslogelasticsearch_CXP9032173 -s /software/items/EXTRlitprsyslogelasticsearch_CXP9032173
