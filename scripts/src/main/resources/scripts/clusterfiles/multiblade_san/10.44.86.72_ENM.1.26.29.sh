...
# Copy of 10.44.86.72.sh - but uses older ENM iso - for use with LITP isos pre 2.85.5
...
# ST-CDB: TC VCS_Runtime
copytestfile5="http://10.44.235.150/st/vm-images/test_image-1.0.37.qcow2:/var/www/html/images/STCDB_test_image.qcow2"
...
# ST-CDB: ROBUSTNESS
copytestfile13="http://10.44.235.150/st/test-packages/EXTR-lsbwrapper40-2.0.0.rpm:/tmp/lsb_pkg/EXTR-lsbwrapper40-2.0.0.rpm" 
# ST-CDB : TC VCS RUNTIME
copytestfile14="http://10.44.235.150/st/test-packages/test_service-2.0-1.noarch.rpm:/tmp/test_service-2.0-1.noarch.rpm"


##### ENM ISO AT DEPLOYMENT

# copy over the ENM ISO. This needs to be updated if changing the ENM ISO
copytestfile60="http://10.44.235.150/st/enm-iso/ERICenm_CXP9027091-1.26.29_aa:/var/www/ERICenm_CXP9027091-1.26.29_aa"
copytestfile61="http://10.44.235.150/st/enm-iso/ERICenm_CXP9027091-1.26.29_ab:/var/www/ERICenm_CXP9027091-1.26.29_ab"
copytestfile62="http://10.44.235.150/st/enm-iso/ERICenm_CXP9027091-1.26.29_ac:/var/www/ERICenm_CXP9027091-1.26.29_ac"
jointestfile1="/var/www/ERICenm_CXP9027091-1.26.29_*:/tmp/ERICenm_CXP9027091-1.26.29.iso"

# this is the XML used to create all the package and package list items under /software
copytestfile42="http://10.44.235.150/st/enm-iso/enm_package_1.26.29.xml:/tmp/enm_package_2.xml"
# bash script that handles the import of the ENM ISO and polling maintenace mode to see when it completes
copytestfile43="http://10.44.235.150/st/enm-iso/import_iso.sh:/tmp/import_iso.sh"
...
copytestfile44="http://10.44.235.150/st/enm-iso/root_import_iso.exp:/tmp/root_import_iso.exp"
