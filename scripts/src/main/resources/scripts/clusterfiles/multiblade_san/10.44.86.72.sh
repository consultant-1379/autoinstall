...
copytestfile60="http://10.44.235.150/st/enm-iso/ERICenm_CXP9027091-1.63.96.iso:/tmp/ERICenm_CXP9027091-1.63.96.iso"

# this is the XML used to create all the package and package list items under /software
copytestfile42="http://10.44.235.150/st/enm-iso/enm_package_2.xml:/tmp/enm_package_2.xml"
