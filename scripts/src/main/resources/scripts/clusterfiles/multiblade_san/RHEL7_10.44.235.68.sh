...
# A different file is needed for RHEL7 as the MS macaddresses are different after a RHEL7 install
...
ms_eth4_mac="ac:16:2d:6e:a4:54" # RHEL7
ms_eth5_mac="ac:16:2d:6e:a4:55" # RHEL7

ms_sysname="DL380"
ms_disk_uuid="600508b1001c9a93e08d3a1a32624ee9"
