...
class AIRunner():
    def __init__(
            ...
            update_rsyslog8, reboot_peer_nodes, run_old_cleanup,
            skip_peer_node_passwd, skip_install_snapshot, expect_large_plan,
            pre_xml_script, local_trust_auth):
        """
        ...
        stdout, stderr, retc = self.utilfile.run_command_local("hostname -i", logs=False)
...
def main():
    ...
    run = AIRunner(
        ...
        reboot_peer_nodes, run_old_cleanup, skip_peer_node_passwd,
        skip_install_snapshot, expect_large_plan, pre_xml_script,
        local_trust_auth)
