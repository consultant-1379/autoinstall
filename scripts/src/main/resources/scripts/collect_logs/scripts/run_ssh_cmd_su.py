...
class RunSUCommands:
    ...
    def run_cmds(self):
        ...
        print "Connectiong to {0} as {1}".format(self.system_ip, self.system_username)
    ...
    def run_su_cmds(self):
        ...
        try:
            ...
            print "Could not connect to {0}, failed to execute '{1}' command.".format(self.system_ip, self.cmd)
        finally:
            # Close the SSH connection
            client.close()
