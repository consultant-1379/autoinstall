...
#  note - node2 PXE boots from eth1
#
# Simplified
#   no NFS storage
#   only one disk per volume group
#   no eth4 on managed nodes
#
# Usage:
#   RHEL7_deploy_multiblade_san_va_simplified.sh <CLUSTER_SPEC_FILE>
#
...
# Node one PXE boots from eth1
litp create -t eth -p /deployments/d1/clusters/c1/nodes/n1/network_interfaces/if1 -o device_name=eth1 macaddress=${node_eth1_mac[0]} pxe_boot_only=true
