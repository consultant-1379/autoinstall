...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs1          -o type='ext4' mount_point='/'         size='35G' snap_size=50
...
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs3          -o type='ext4' mount_point='/home'     size='6G' snap_size=50
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs4          -o type='ext4' mount_point='/var'      size='35G' snap_size=50
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs5          -o type='ext4' mount_point='/var/log'  size='20G' snap_size=50
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs6          -o type='ext4' mount_point='/var/www'  size='70G' snap_size=50
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs7          -o type='ext4' mount_point='/software' size='70G' snap_size=0
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs8          -o type='ext4' mount_point='/var/lib/mysql'  size='25G' snap_size=50
litp create -t file-system     -p /infrastructure/storage/storage_profiles/profile_ms/volume_groups/vg1/file_systems/fs9          -o type='ext4' mount_point='/var/lib/libvirt' size='20G' snap_size=50
...
litp create -p /infrastructure/systems/sys1/disks/disk0 -t disk -o name=hd0 size=500G bootable=true uuid="${ms_disk_uuid}"
...
#litp create -p /software/images/image2 -t vm-image -o name="FO_SG_vm1" source_uri="http://${ms_ip}/images/image_with_ocf_v1_8.qcow2"
