...
#
# Usage:
#   RHEL7_deploy_cloud_1node.sh <CLUSTER_SPEC_FILE>
#
...
#litp create -p /deployments/d1/clusters/c1/network_hosts/nh13 -t vcs-network-host -o network_name=traffic1 ip="${node_expansion_ip_2[1]}" #NOTE HARDCODED TO 2nd NODE IP
...
litp create -p /deployments/d1/clusters/c1/network_hosts/nh15 -t vcs-network-host -o network_name=traffic2 ip="${node_expansion_ip_3[1]}" #NOTE HARDCODED TO 2nd NODE IP
